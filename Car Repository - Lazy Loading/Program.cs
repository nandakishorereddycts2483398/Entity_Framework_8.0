...
namespace CarProject //DO NOT Change the namespace name
{
    public class Program //DO NOT Change the class name
    {
        public static void Main(string[] args)
        {
            ...
            using (var context=new CarContext()){
                ...
                foreach(var c in cars){
                    Console.WriteLine($"Car Id: {c.Id}, Make: {c.Make?.Name}, Model:{c.Model}, Year; {c.Year}");
                }
            }
        }
        ...
        {
            Expression assignExpr = Expression.Assign(variableExpr, Expression.Constant(context.Cars.Include(c=> c.Make).OrderBy(c=>c.Id).ToList()));
            return assignExpr;
        }
    }
}
